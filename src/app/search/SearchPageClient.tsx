    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 p-4 sm:p-5 glass-card rounded-2xl">
        ...
        <select
          ...
          className="flex-1 px-4 py-2.5 rounded-xl bg-gray-800 text-white cursor-pointer focus:ring-2 focus:ring-primary-500 focus:outline-none shadow-sm transition-all duration-200"
        >
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-semibold bg-gray-700 text-gray-200 rounded-xl hover:bg-gray-600 transition-all duration-200 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isCreatingList ? (
