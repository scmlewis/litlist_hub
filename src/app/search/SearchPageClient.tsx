...
export function SearchPageClient() {
  ...
  return (
    <div className="space-y-6">
      {/* List selector */}
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 p-4 sm:p-5 bg-white border border-border rounded-2xl shadow-elevation-1">
        ...
        <select
          ...
          className="flex-1 px-4 py-2.5 rounded-xl bg-muted text-foreground focus:ring-2 focus:ring-ring focus:outline-none shadow-sm transition-all duration-200"
        >
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-semibold bg-muted text-foreground rounded-xl hover:bg-muted/80 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isCreatingList ? (
