      ...
      >
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3.5 sm:py-4 glass-card rounded-2xl text-white placeholder-gray-500 focus:ring-2 focus:ring-primary-500 focus:outline-none transition-all duration-200"
          />
        </div>
        <button
          type="submit"
